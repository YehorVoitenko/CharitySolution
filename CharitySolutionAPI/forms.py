...
class OrganisationForm(ModelForm):
    class Meta:
        model = Organisation
        fields = ["organisation_name", "organisation_description", "city", "email", "telegram_nick", "instagram_nick",
                  "organisation_site_url", "organisation_logo"]

        widgets = {'organisation_description': Textarea(
            attrs={
                "class": "form-control",
